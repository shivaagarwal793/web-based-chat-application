...
<title>MyChat - HOME</title>
    ...
    <link rel="stylesheet" type="text/css" src="https://maxcdn.bootstrapcdn.com/bootstrap/font-awesome/4.7.0/css/font-awesome.min.css">   
...
<body>
    <div class="container main-section">
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
                <div class="input-group searchbox">
                    <div class="input-group-btn">
                        <center>
                            <a href="https://www.geeksforgeeks.org/rsa-algorithm-cryptography/"><button class="btn btn-default search-icon" name="search_user" type="submit">
                                End-to-End Encrypted</button>
                            </a>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                ...
                <div class="row">
                <center><br><img src='lock.png' width='20' height='20' /> Chatting is END to End Secure </center>
                <
                                    ...
                                    echo"
                                        <li>
                                            ...
                                            <div class='rightside-left-chat'>
                                                ...
                                                <p>$msg_content</p>
                                                <br> Now delivered <img src='lock.png' width='20' height='20' />
                                                <br>
                                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 right-chat-textbox">
                        <form method="post">
                            <input autocomplete="off" type="text" name="msg_content" placeholder="Send END TO END Encrypted Message.......">
    ...
    <?php
        if (isset($_POST['submit']))
        {
            ...
            if($msg == ""){
                ...
                $insert = "insert into users_chat(sender_username, receiver_username, msg_content, msg_status, msg_date) values
   ...
   ?>
            ...
            <script>
                $('#scrolling_to_bottom').animate({scrollTop: $('#scrolling_to_bottom').get(0).scrollHeight}, 1000);
            </script> 
